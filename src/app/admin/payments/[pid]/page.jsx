...
import OrderList from "@/components/table/rows/orderList";
import ShopDetailCover from "@/components/_admin/shops/shopDetailCover";
import ShopDetail from "@/components/_admin/shops/shopDetail";
...
export default function Page({ params: { pid } }) {
  ...
  const { data, isLoading } = useQuery(
    ["shop-payment", pageParam],
    () => api.getIncomeDetailsByAdmin(pid, pageParam),
    {
      onError: (err) =>
