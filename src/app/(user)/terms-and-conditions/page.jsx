  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      <Typography variant="body1" paragraph>
        Welcome to PartsWala! These terms and conditions outline the rules and
        regulations for the use of PartsWala&apos;s Website.
      </Typography>
      <Typography variant="body1" paragraph>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use PartsWala if you do not agree to take
      ...
      <Typography variant="body1" paragraph>
        Unless otherwise stated, PartsWala and/or its licensors own the
        intellectual property rights for all material on PartsWala. All
        intellectual property rights are reserved. You may access this from
        PartsWala for your own personal use subjected to restrictions set in
      ...
      <Typography variant="body1" paragraph>
        ...
        PartsWala does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of PartsWala, its agents, and/or affiliates. Comments reflect
