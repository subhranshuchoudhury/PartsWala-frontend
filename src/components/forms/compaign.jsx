...
import Search from "@/components/dialog/search/search";
...
export default function CompaignForm({
  data: currentCompaign,
  isLoading: compaignLoading,
}) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      startDate: currentCompaign?.startDate
        ? format(parseISO(currentCompaign?.startDate), "yyyy-MM-dd")
        : "",

      endDate: currentCompaign?.endDate
        ? format(parseISO(currentCompaign?.endDate), "yyyy-MM-dd")
        : "",
