    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={[styles.gridContainer, styles.mb40]}>
          <Image source="/nav_logo.png" alt="" style={{ height: 32 }} />
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body1}>PartsWala</Text>
            <Text style={styles.body1}>London, England</Text>
            <Text style={styles.body1}>+123 4567 890</Text>
            <Text style={styles.body1}> info@PartsWala.com</Text>
          </View>
          <View style={styles.col6}>
            ...
            <Text style={styles.body1}>
              {data?.user?.address},{data?.user?.zip},{data?.user?.city},
