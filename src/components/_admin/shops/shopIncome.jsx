...
import IncomeList from "@/components/table/rows/income";
import EditPaymentDialog from "@/components/dialog/editPayment";
...
export default function ShopIcomeList({ slug, onUpdatePayment, isVendor }) {
  ...
  const { data, isLoading: loadingList } = useQuery(
    ...
    () =>
      api[isVendor ? "getIncomeByVendor" : "getShopIncomeByAdmin"](
        slug,
        pageParam
      ),
    {
