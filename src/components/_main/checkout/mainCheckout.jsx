...
import PayPalPaymentMethod from "@/components/paypal/paypal";
...
const ShipmentCheckoutForm = dynamic(
  () => import("@/components/forms/shipmentAddress"),
  {
    loading: () => <CheckoutGuestFormSkeleton />,
  }
);
const PaymentInfo = dynamic(
  () => import("@/components/_main/checkout/paymentInfo"),
  {
    loading: () => <PaymentInfoSkeleton />,
  }
);
const PaymentMethodCard = dynamic(
  () => import("@/components/_main/checkout/paymentMethod"),
  {
...
const CheckoutMain = () => {
  ...
  const { errors, values, touched, handleSubmit, getFieldProps, isValid } =
    formik;
