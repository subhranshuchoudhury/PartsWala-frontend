        ...
        <Grid container spacing={3}>
          ...
          >
            ...
            <Typography variant="h2" fontWeight={800}>
              PartsWala - The Best Automobile Parts Store
            </Typography>
            <Typography
              variant="body1"
              fontWeight={400}
              ...
              mt={2}
            >
              PartsWala is a leading automobile parts store in the USA. We have
              a complete selection of high-quality parts for a wide range of
              vehicle makes and models - offered at the lowest prices. We also
              take the lead when it comes to hassle-free online shopping with
