...
import { getRequestsWithFetch } from "./http";
...
export const adminDashboardAnalytics = async () => {
  ...
  const data = await getRequestsWithFetch("/admin/dashboard-analytics");
  return data;
};
export const getNotifications = async (page) => {
  // const { data } = await http.get(`/admin/notifications?limit=${page}`, {});
  const data = await getRequestsWithFetch(`/admin/notifications?limit=${page}`);
  return data;
};
...
export const getBrandsByAdmin = async (page, search) => {
  ...
  // );
  const data = await getRequestsWithFetch(
    `/admin/brands?search=${search}&page=${page}`
  );
  return data;
};
export const getBrandByAdmin = async (id) => {
  ...
  const data = await getRequestsWithFetch(`/admin/brands/${id}`);
  return data;
};
export const getAllBrandsByAdmin = async () => {
  // const { data } = await http.get(`/admin/all-brands`);
  const data = await getRequestsWithFetch(`/admin/all-brands`);
  return data;
};
...
export const getCategoryByAdmin = async (slug) => {
  ...
  const data = await getRequestsWithFetch(`/admin/categories/${slug}`);
  return data;
};
...
export const getProductsByAdmin = async (params) => {
  ...
  const response = await getRequestsWithFetch(`/admin/products?${params}`);
  return response;
};
...
export const getOrdersByAdmin = async (payload) => {
  ...
  const data = await getRequestsWithFetch(`/admin/orders?${payload}`);
  return data;
};
export const getOrderByAdmin = async (id) => {
  // const { data } = await http.get(`/admin/orders/${id}`);
  const data = await getRequestsWithFetch(`/admin/orders/${id}`);
  return data;
};
...
export const getUserByAdminsByAdmin = async (page, search) => {
  ...
  // );
  const response = await getRequestsWithFetch(
    `/admin/users?search=${search}&page=${page}`
  );
  return response;
};
export const getUserByAdmin = async (id) => {
  ...
  const response = await getRequestsWithFetch(`/admin/users/${id}`);
  return response;
};
...
export const getCouponCodeByAdmin = async (id) => {
  ...
  const response = await getRequestsWithFetch(`/admin/coupon-codes/${id}`);
  return response;
};
...
export const getNewsletter = async (page) => {
  ...
  const data = await getRequestsWithFetch(`/admin/newsletter?page=${page}`);
  return data;
};
export const getShopDetailsByAdmin = async (slug) => {
  // const { data } = await http.get(`/admin/shops/${slug}`);
  const data = await getRequestsWithFetch(`/admin/shops/${slug}`);
  return data;
};
...
export const getPayoutsByAdmin = async (params) => {
  ...
  const data = await getRequestsWithFetch(`/admin/payouts?${params}`);
  return data;
};
export const getAllShopsByAdmin = async () => {
  // const { data } = await http.get(`/admin/all-shops`);
  const data = await getRequestsWithFetch(`/admin/all-shops`);
  return data;
};
...
export const getCurrencyByAdmin = async (cid) => {
  ...
  const data = await getRequestsWithFetch(`/admin/currencies/${cid}`);
  return data;
};
...
export const getCompaignByAdmin = async (slug) => {
  ...
  const data = await getRequestsWithFetch(`/admin/compaigns/${slug}`);
  return data;
};
...
export const getVendorProductBySlug = async (slug) => {
  ...
  const data = await getRequestsWithFetch(`/vendor/products/${slug}`);
  return data;
};
export const getVendorShop = async () => {
  // const { data } = await http.get(`/vendor/shop`);
  const data = await getRequestsWithFetch(`/vendor/shop`);
  return data;
};
export const vendorDashboardAnalytics = async () => {
  // const { data } = await http.get(`/vendor/dashboard-analytics`);
  const data = await getRequestsWithFetch(`/vendor/dashboard-analytics`);
  return data;
};
...
export const getOrdersByVendor = async (payload) => {
  ...
  const data = await getRequestsWithFetch(`/vendor/orders?${payload}`);
  return data;
};
...
export const getProductDetails = async (pid) => {
  ...
  const data = await getRequestsWithFetch(`/products/${pid}`);
  return data;
};
...
export const getProductSlugs = async () => {
  ...
  const data = await getRequestsWithFetch(`/products-slugs`);
  return data;
};
...
export const getUserInvoice = async (page) => {
  ...
  const response = await getRequestsWithFetch(`/users/invoice${page}`);
  return response;
};
...
export const getAddress = async (payload) => {
  ...
  const data = await getRequestsWithFetch(`/users/addresses?id=${payload}`);
  return data;
};
...
export const getSearchFilters = async () => {
  ...
  const data = await getRequestsWithFetch(`/search-filters`);
  return data;
};
export const getInvoices = async () => {
  // const { data } = await http.get(`/users/invoice`);
  const data = await getRequestsWithFetch(`/users/invoice`);
  return data;
};
...
export const getLayout = async () => {
  ...
  const data = await getRequestsWithFetch(`/layout`);
  return data;
};
...
export const getWishlist = async () => {
  ...
  const data = await getRequestsWithFetch(`/wishlist`);
  return data;
};
...
export const getProfile = async () => {
  ...
  const data = await getRequestsWithFetch(`/users/profile`);
  return data;
};
...
export const getShopByUser = async () => {
  ...
  const data = await getRequestsWithFetch(`/user/shop`);
  return data;
};

export const getShops = async () => {
  // const { data } = await http.get(`/shops`);
  const data = await getRequestsWithFetch(`/shops`);
  return data;
};
